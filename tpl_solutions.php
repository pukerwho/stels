...
<div class="p_solutions">
	<div class="welcome" style="background: url('<?php echo carbon_get_the_post_meta('crb_solutions_photo') ?>');">
		<div class="welcome__bottom">
			<div class="welcome__title">
				<div class="welcome__title-inner">
					<?php echo carbon_get_the_post_meta('crb_solutions_title') ?>
				</div>
			</div>
					...
					<div class="row justify-content-center">
						<div class="col-md-8">
							<div class="welcome__description-inner">
								<?php echo carbon_get_the_post_meta('crb_solutions_description') ?>
							</div>
						</div>
					</div>
				</div>
